...
{
    public interface IShawLeadsViewModelAdapter
    {
        ShawLeadsViewModel BuildShawLeadsViewModel(IEnumerable<CRMLeadDataModel> leads, List<string> accountObjectIDs, DateTime startDate, DateTime endDate);
    }

    public class ShawLeadsViewModelAdapter : IShawLeadsViewModelAdapter
    {
        public ShawLeadsViewModel BuildShawLeadsViewModel(IEnumerable<CRMLeadDataModel> leads, List<string> accountObjectIDs, DateTime startDate, DateTime endDate)
        {
            ShawLeadsViewModel model = new ShawLeadsViewModel();
        ...
        public void AddAttributes(ShawLeadsViewModel model, DateTime startDate, DateTime endDate, List<string> accountObjectIDs)
        {
        ...
        public void AddPageTitle(ShawLeadsViewModel model)
        {
        ...
        public void AddLeadsData(ShawLeadsViewModel model, IEnumerable<CRMLeadDataModel> leads, List<string> accountObjectIDs)
        {
