...
function createChart() {
    if ($('#leads_Chart').length) {
        var echart = echarts.init(document.getElementById('leads_Chart'), GetTheme());
        echart.setOption({
            title: {
                text: '',
                subtext: ''
...
function generateLeadsDataTable() {
    ...
    $('#leads').DataTable({
        ...
        "fnServerParams": function (aoData) {
            aoData.DataTableIdentifier = _leadsIdentifer;
        },
