...
namespace mxtrAutomation.Websites.Platform.Queries
{
    ...
    public class AdminEditAccountAttributesSubmitWebQuery : WebQueryBase<AccountAttributesViewData>
    {
        public static readonly string Route = "/admin/edit-account-attributes-submit";
    }
}